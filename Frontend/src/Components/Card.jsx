  ...
  return (
    <>
      <div className="mt-5 my-2 p-3 ">
        <div className="card bg-base-100 w-90 shadow-xl hover:scale-105 duration-300 cursor-pointer dark:bg-slate-950 dark:text-white dark:border dark:rounded-xl">
          <figure>
